...
$accounts = $pdo->query('SELECT * FROM accounts WHERE cast(registered as DATE) = cast("' . $date . '" as DATE) ORDER BY registered DESC')->fetchAll(PDO::FETCH_ASSOC);
// Total accounts that were last active over a month ago
$inactive_accounts = $pdo->query('SELECT COUNT(*) AS total FROM accounts WHERE last_seen < date_sub("' . $date . '", interval 1 month)')->fetchColumn();
// Accounts that are active in the last day
$active_accounts = $pdo->query('SELECT * FROM accounts WHERE last_seen > date_sub("' . $date . '", interval 1 day) ORDER BY last_seen DESC')->fetchAll(PDO::FETCH_ASSOC);
// Accounts that are active in the last day
...
<div class="dashboard">
    <div class="content-block stat">
        <div class="data">
            <h3>New Accounts <span>&lt;1 day</span></h3>
            <p><?=$accounts ? number_format(count($accounts)) : 0?></p>
        </div>
        <div class="icon">
    ...
    <div class="content-block stat cyan">
        <div class="data">
            ...
            <p><?=number_format($active_accounts_total)?></p>
        </div>
        <div class="icon">
    ...
    <div class="content-block stat red">
        <div class="data">
            ...
            <p><?=$inactive_accounts ? number_format($inactive_accounts) : 0?></p>
        </div>
        <div class="icon">
    ...
    <div class="content-title" style="margin-top:40px">
        <div class="title">
            ...
            <div class="txt">
                ...
                <p>Accounts inactive in the last >30 days.</p>
            </div>
        </div>
    </div>
